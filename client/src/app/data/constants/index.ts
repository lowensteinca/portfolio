...
export const WhoAmI: Engineer = {
  ...
  intro: 'Versatile Senior Software Engineer with expertise in designing, developing, and delivering scalable enterprise software. Proven success in front-end and back-end engineering, releasing products for businesses of all sizes. Skilled in modernizing systems, managing technical documentation, mentoring developers, and crafting impactful, future-proof solutions that balance technical feasibility with strategic goals.',
  opentofeedback: true,
  opentowork: true,
  contacts: [
    {
